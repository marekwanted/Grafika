...
//
//	// wczytanie tekstury pavarotti.tga
//	GLboolean error = load_targa("pavarotti.tga", width, height, format, type, pixels);
//
//	// błąd odczytu pliku
//	if (error == GL_FALSE)
//	{
//		printf("Niepoprawny odczyt pliku pavarotti.tga");
//		exit(0);
//	}
//
...
//
//	// wczytanie tekstury pavarotti_gray.tga
//	error = load_targa("pavarotti_gray.tga", width, height, format, type, pixels);
//
//	// błąd odczytu pliku
//	if (error == GL_FALSE)
//	{
//		printf("Niepoprawny odczyt pliku pavarotti_gray.tga");
//		exit(0);
//	}
//
//	// utworzenie identyfikatora tekstury
...
//	glutAddMenuEntry("pavarotti.tga (kompresja)", TEXTURE_LENA);
//	glutAddMenuEntry("pavarotti.tga (bez kompresji)", TEXTURE_LENA_UNC);
//	glutAddMenuEntry("pavarotti_gray.tga (kompresja)", TEXTURE_LENA_GRAY);
//	glutAddMenuEntry("pavarotti_gray.tga (bez kompresji)", TEXTURE_LENA_GRAY_UNC);
//
